...
public class StudentService {
    ...
    public StudentResponse updateStudent(String id, StudentRequest request) {
        ...
        if (existingStudent.isPresent()) {
            ...
            // Send WebSocket notification
            webSocketNotificationService.sendStudentNotification("UPDATE", response, currentUser);
    ...
    public boolean deleteStudent(String id) {
        ...
        if (studentOpt.isPresent()) {
            ...
            // Send WebSocket notification
            StudentResponse deletedStudentResponse = new StudentResponse();
            deletedStudentResponse.setId(id);
            deletedStudentResponse.setName(studentName);
            deletedStudentResponse.setEmail(student.getEmail());
            deletedStudentResponse.setAge(student.getAge());
            webSocketNotificationService.sendStudentNotification("DELETE", deletedStudentResponse, currentUser);
    ...
    public void clearAllCache() {
        ...
        // Send WebSocket notification about cache clear
        webSocketNotificationService.sendCacheNotification("all-student-caches", "cleared");
    }
