...
/**
 * LESSON 5: Student Controller - MongoDB
 * REST API controller với MongoDB (String ID)
 */
@RestController
...
public class StudentController {
    ...
    /**
     * Convert Student document to StudentResponse DTO
     */
    private StudentResponse convertToResponse(Student student) {
        return new StudentResponse(
            student.getId(), // String ID từ MongoDB
            student.getName(),
            student.getEmail(),
            student.getAge()
        );
    ...
    /**
     * Convert StudentRequest DTO to Student document
     */
